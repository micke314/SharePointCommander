...
- 2026-05-27T09:02:11+02:00 — Created SharePointCommander-tests GitHub repo (public) with Playwright E2E scaffolding: chromium headless, 3 test suites (smoke, keyboard-navigation, file-listing). Coverage: overlay lifecycle, Escape regression (BUG-1/BUG-2), End key off-by-one fix (commit 3fc12ce), parent entry rendering, folder/back nav, live filter. Tests ready for CI/CD integration.
